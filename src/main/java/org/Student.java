...
package org;  //Student class that stores a student name and average.
public class Student {
    private String name;
    private double average;

    //constructor initializes instance variables
    public Student(final String name, final double average) {
        this.name = name;
    ...
    // determines and returns the Studenet's letter grade
